...
def zotero_profile_evidence(
    ...
    effective_collections = collection_names if collection_names is not None else list(cfg.profile_collections)
...
def zotero_save_papers(
    ...
    client, cfg = _client(config_path)
    effective_collections = collection_names if collection_names is not None else list(cfg.feedback_default_collections)
...
def zotero_apply_feedback(
    ...
    return client.apply_feedback(normalized, dry_run=dry_run)
